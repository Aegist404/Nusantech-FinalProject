        ...
        <div className="flex justify-center">
            <div className="w-2/3">
                ...
                <div className='flex justify-end'>
                    <button onClick={openPopup} className="text-blue-500 underline">Edit</button>
                    <Popup isOpen={isPopupOpen} onClose={closePopup} />
                </div>
                <div className="flex items-center mb-4 ">
                    <table className="border-collapse border w-2/4 ml-auto">
                ...
                <div className="flex justify-end">
                    <button className="bg-blue-500 mb-4 text-white py-2 px-4 rounded-md" onClick={() => { }}>
                        BAYAR
                    </button>
                </div>
            </div>
