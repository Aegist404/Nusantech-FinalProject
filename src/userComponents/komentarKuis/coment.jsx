...
// import { DownOutlined, SmileOutlined } from '@ant-design/icons';x  
...
const Comment = ({ author, text, replies }) => {
  ...
  return (
    ...
    <div className="flex items-start">
      ...
      {replies.length > 0 && (
        <button
          className="text-gray-400 mt-2 hover text-sm ml-12 no-underline"
      ...
      {showReplies && (
        <div className="ml-8 mt-2 space-y-2 ml-[50px]">
